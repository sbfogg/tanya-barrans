 ...
 * Slug: tanya-barrans/cta
 * Categories: featured
 */
?>
<!-- wp:group {"align":"full","className":"tb-closing-cta","backgroundColor":"charcoal","textColor":"base","layout":{"type":"constrained","contentSize":"920px"}} -->
<div class="wp-block-group alignfull tb-closing-cta has-base-color has-charcoal-background-color has-text-color has-background">

	<!-- wp:group {"className":"tb-closing-cta__inner tb-reveal","layout":{"type":"constrained","contentSize":"760px"}} -->
	<div class="wp-block-group tb-closing-cta__inner tb-reveal">
		<!-- wp:paragraph {"className":"tb-script-accent"} -->
		<p class="tb-script-accent">When you’re ready</p>
		<!-- /wp:paragraph -->
		...
		<p class="has-text-align-center has-stone-color has-text-color">Whether you are three years or three weeks from a move, Tanya will give you an honest look at your options—without pressure.</p>
		<!-- /wp:paragraph -->
