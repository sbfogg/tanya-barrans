...
<div class="wp-block-group alignfull tb-reveal has-base-color has-coral-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--40)">
	...
	<p class="has-text-align-center has-base-color has-text-color">Whether you're three years or three weeks from a move, let's talk about what's possible. No pressure, no obligation — just honest answers.</p>
	<!-- /wp:paragraph -->

	<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"},"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
	<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
		<!-- wp:button {"backgroundColor":"base","textColor":"ink"} -->
		<div class="wp-block-button"><a class="wp-block-button__link has-ink-color has-base-background-color has-text-color has-background wp-element-button" href="/contact/">Get In Touch</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
